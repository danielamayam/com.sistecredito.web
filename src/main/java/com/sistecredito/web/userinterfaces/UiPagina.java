...
public class UiPagina extends PageObject{
    ...
    public static final Target BTN_CERRAR_CARRITO = Target.the("Botón cerrar modal").located(By.xpath("(//button[@class='icon-button icon-button-default icon-button-transparent icon-button-md'])[7]"));
    ...
    public static final Target TXT_CANTIDAD = Target.the("").locatedBy("//a[contains(text(),'{0}')]//ancestor::div[@class='relative py-4 px-2 md:p-4 grid grid-cols-1 space-y-2 lg:grid-cols-2']//child::input");
